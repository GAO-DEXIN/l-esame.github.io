...
<body>
    ...
    <section class="animation1">
        <img class="syqzuo" src="image/人物左.jpg">
        <img class="syqzhong" src="image/人物中.jpg">
        <img class="syqyou" src="image/人物右.jpg">
        <img class="beijingzhong" src="image/底色.png">
        <img class="beijingzuo" src="image/底色.png">
        <img class="beijingyou" src="image/底色.png">
        <img class="wenzi1" src="image/我叫石月乔.png">
        <img class="wenzi2" src="image/mi chiamo shiyueqiao.png">
        <img class="syqduli" src="image/人抠图.png">
        <img class="yuanquan" src="image/圆圈.png">
        <img class="nenglizhi" src="image/能力图.png">
    </section>
    <section class="animation2">
        <img class="gif1" src="image/first-gif.gif">
        <img class="white" src="image/白色.jpg">
        <img class="bengong" src="image/本宫的美照.png">
        <img class="jikechufa" src="image/即刻出发_画板 1.svg">
    </section>
    <div class="buchong">
        <div  class="image1">
            <img src="image/微信图片_20200424104348.jpg" width="1200px">
        </div>
        <div  class="image2">
            <img src="image/微信图片_20200424104402.jpg" height="600px">
        </div>
        <div  class="image3">
            <img src="image/微信图片_20200424104439.jpg" height="600px">
        </div>
        <div  class="image4">
            <img src="image/微信图片_20200424104418.jpg" width="1200px">
        </div>
        <div  class="image5">
            <img src="image/微信图片_20200424104433.jpg" width="380px">
        </div>
        <div  class="image6">
            <img src="image/微信图片_20200424104411.jpg" width="380px">
        </div>
        <div  class="image7">
            <img src="image/微信图片_20200424104428.jpg" width="380px">
        </div>
    </div>
    ...
    <div class="fengdi">
        <img class="fengditu" src="image/封底白.jpg" width="1800px">
    </div>
